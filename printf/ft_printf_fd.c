...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/05/16 14:02:42 by aemilien          #+#    #+#             */
/*   Updated: 2017/05/16 14:17:02 by aemilien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		set_buffer(t_list *list, int *n, int fd)
{
	while (list)
	{
		if (((t_arg*)list->content)->str)
			ft_putstr_fd(((t_arg*)list->content)->str, fd);
